        ...
        <div className=" smartelement" id="smartelement">
            ...
            <div className="element2 element">
                <div className="product product-tool white-color" data-aos="fade-up-right" data-aos-duration="1000">
                    <div className="element-card">
                        <img src={imgTool} alt="img of Tool"  className="tool-icon"/>
                        <h2 className="tool-header">Замена оборудования.Авансовая замена</h2>
                    </div>
                    <h4>Сервисный контракт</h4>
                    <p>Авансовая замена 24х7х7, 8х5х4, NBD</p>
                    <hr/>
                    <h4>Гарантия</h4>
                    <p>От 10 дней, отгрузка из Амсердама</p> 
                </div>
                <div className="product product-group blue-color" data-aos="fade-up-left" data-aos-duration="1000" >
                    <div className="element-card">
            ...
            <div className="elemennt3 element">
                <div className="product product-apps blue-color" data-aos="fade-up-right" data-aos-duration="1000">
                    <div className="element-card">
